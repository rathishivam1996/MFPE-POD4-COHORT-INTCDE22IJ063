...
public class AccountController { 
	...
	@GetMapping("/")
	public String home() {
		log.info("Home Check for Account Microservice");
		log.info("health checkup ----->{}", "up");
		return "retail-bank-account-ms";
	}
	...
	public ResponseEntity<String> healthCheckup() {
		log.info("Health Check for Account Microservice");
		log.info("health checkup ----->{}", "up");
		return new ResponseEntity<>("UP retail-bank-account-ms", HttpStatus.OK);
	}
