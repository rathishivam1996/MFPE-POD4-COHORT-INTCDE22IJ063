...
public class TransactionRestController {
	...
	@GetMapping("/")
	public String home() {
		log.info("Home Check for Transaction Microservice");
		log.info("health checkup ----->{}", "up");
		return "retail-bank-transaction-ms";
	}
	...
	public ResponseEntity<String> healthCheckup() {
		log.info("Health Check for Transaction Microservice");
		log.info("health checkup ----->{}", "up");
		return new ResponseEntity<>("UP. retail-bank-transaction-ms", HttpStatus.OK);
	}
